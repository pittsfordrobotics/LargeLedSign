...
Digit8PixelBuffer::Digit8PixelBuffer(int gpioPin) : PixelBuffer(gpioPin)
{
    ...
    m_rows.push_back(new std::vector<int>{ 234, 235, 236, 237, 240, 241, 242, 243, 244});
    m_rows.push_back(new std::vector<int>{ 230, 231, 232, 233, 238, 245, 246, 247, 248});
    m_rows.push_back(new std::vector<int>{ 225, 226, 227, 228, 229, 249, 250, 251, 252, 253});
    m_rows.push_back(new std::vector<int>{ 220, 221, 222, 223, 224, 239, 254, 255, 256, 257});
    m_rows.push_back(new std::vector<int>{ 214, 215, 216, 217, 218, 219, 258, 259, 260, 261, 262});
    m_rows.push_back(new std::vector<int>{ 210, 211, 212, 213, 263, 264, 265, 266});
    m_rows.push_back(new std::vector<int>{ 205, 206, 207, 208, 209, 267, 268, 269, 270, 271});
    m_rows.push_back(new std::vector<int>{ 201, 202, 203, 204, 272, 273, 274, 275});
    m_rows.push_back(new std::vector<int>{ 196, 197, 198, 199, 200, 276, 277, 278, 279, 280, 281});
    m_rows.push_back(new std::vector<int>{ 192, 193, 194, 195, 282, 283, 284, 285, 286});
    m_rows.push_back(new std::vector<int>{ 187, 188, 189, 190, 191, 287, 288, 289, 290, 291});
    m_rows.push_back(new std::vector<int>{ 183, 184, 185, 186, 292, 293, 294, 295});
    m_rows.push_back(new std::vector<int>{ 178, 179, 180, 181, 182, 296, 297, 298, 299});
