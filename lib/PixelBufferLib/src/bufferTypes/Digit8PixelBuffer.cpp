...
Digit8PixelBuffer::Digit8PixelBuffer(int gpioPin) : PixelBuffer(gpioPin)
{
    ...
    m_rows.push_back(new std::vector<int>{ 234, 235, 236, 237, 295, 296, 297, 298});
    m_rows.push_back(new std::vector<int>{ 230, 231, 232, 233, 238, 291, 292, 293, 294});
    m_rows.push_back(new std::vector<int>{ 225, 226, 227, 228, 229, 286, 287, 288, 289, 290});
    m_rows.push_back(new std::vector<int>{ 220, 221, 222, 223, 224, 239, 281, 282, 283, 284, 285});
    m_rows.push_back(new std::vector<int>{ 214, 215, 216, 217, 218, 219, 275, 276, 277, 278, 279, 280});
    m_rows.push_back(new std::vector<int>{ 210, 211, 212, 213, 271, 272, 273, 274});
    m_rows.push_back(new std::vector<int>{ 205, 206, 207, 208, 209, 266, 267, 268, 269, 270});
    m_rows.push_back(new std::vector<int>{ 201, 202, 203, 204, 262, 263, 264, 265});
    m_rows.push_back(new std::vector<int>{ 196, 197, 198, 199, 200, 257, 258, 259, 260, 261});
    m_rows.push_back(new std::vector<int>{ 192, 193, 194, 195, 253, 254, 255, 256});
    m_rows.push_back(new std::vector<int>{ 187, 188, 189, 190, 191, 248, 249, 250, 251, 252});
    m_rows.push_back(new std::vector<int>{ 183, 184, 185, 186, 244, 245, 246, 247});
    m_rows.push_back(new std::vector<int>{ 178, 179, 180, 181, 182, 240, 241, 242, 243});
